...
function blacksite($array,$siteurl){
	for($i = 0;$i < count($array); $i++){
		$url = $siteurl."/".urlencode($array[$i]);
...
'1234.php'),
	...
	echo "BlackSite Scan Shell Backdoor :\n";
	switch($act2){
		case "start":
			blacksite($link["php"],$siteurl);
